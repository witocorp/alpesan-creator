...
$(document).ready(function () {
  ...
  $("#cn10").on("click", function () {
    $("#anexos").append('<div class="container"><div class="portlet-header"><img src="img/move.png"></div><div class="eliminar_box">X</div><div class="menu_link"><img src="img/menu.png"></div> <div id="edit' + contador + '" data-id-creator="' + contador + '"> <div class="row py-5"> <div class="col py-5"> <div class="fdb-box fdb-touch"> <div class="row text-center justify-content-center"> <div class="col-12 col-md-9 col-lg-7"> <h1>Contact Us</h1> <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vel efficitur leo. Aliquam in aliquam metus.</p> </div> </div> <div class="row justify-content-center pt-4"> <div class="col-12 col-md-8"> <form> <div class="row"> <div class="col-12 col-md"> <input id="nombre_form" type="text" class="form-control" placeholder="Vorname"> </div> <div class="col-12 col-md mt-4 mt-md-0"> <input id="apellido_form" type="text" class="form-control" placeholder="Name"> </div> </div> <div class="row mt-4"> <div class="col"> <input id="telefono_form" type="text" class="form-control" placeholder="Tel."> </div> </div> <div class="row mt-4"> <div class="col"> <input id="email_form" type="email" class="form-control" placeholder="E-mail"> </div> </div>  <div class="row mt-4"> <div class="col"> <input id="direccion_form" type="text" class="form-control" placeholder="Strasse"> </div> </div> <div class="row mt-4"> <div class="col"> <input id="cp_form" type="input" class="form-control" placeholder="Postleitzahl"> </div> </div> <div class="row mt-4"> <div class="col"> <input id="ciudad_form" type="input" class="form-control" placeholder="Stadt"> </div> </div> <div id="addtoform" class="mt-4"></div> <div class="row mt-4"> <div class="col"> <div class="form-check"> <input class="form-check-input" type="checkbox" value="1" id="polPri"> <label class="form-check-label" for="flexCheckDefault">  Akzeptieren Sie <a href="#" data-bs-toggle="modal" data-bs-target="#privacidadModal">private Richtlinien</a> </label> </div> </div> </div> <div class="row mt-4"> <div class="col text-center"> <button id="enviar_form" data-lan="al" type="submit" class="btn btn-primary">BESTELLEN</button></div> </div> </form> </div> </div> </div> </div> </div> </div> </div>');
    (function () {
      editor.push(
        new FroalaEditor("#edit" + contador, {
          toolbarButtons: [
  ...
  $("#cn11").on("click", function () {
    $("#anexos").append('<div class="container"><div class="portlet-header"><img src="img/move.png"></div><div class="eliminar_box">X</div><div class="menu_link"><img src="img/menu.png"></div> <div id="edit' + contador + '" data-id-creator="' + contador + '"> <div class="row py-5"> <div class="col py-5"> <div class="fdb-box fdb-touch"> <div class="row text-center justify-content-center"> <div class="col-12 col-md-9 col-lg-7"> <h1>Contact Us</h1> <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vel efficitur leo. Aliquam in aliquam metus.</p> </div> </div> <div class="row justify-content-center pt-4"> <div class="col-12 col-md-8"> <form> <div class="row"> <div class="col-12 col-md"> <input id="nombre_form" type="text" class="form-control" placeholder="Vorname"> </div> <div class="col-12 col-md mt-4 mt-md-0"> <input id="apellido_form" type="text" class="form-control" placeholder="Name"> </div> </div> <div class="row mt-4"> <div class="col"> <input id="telefono_form" type="text" class="form-control" placeholder="Tel."> </div> </div> <div class="row mt-4"> <div class="col"> <input id="email_form" type="email" class="form-control" placeholder="E-mail"> </div> </div>  <div class="row mt-4"> <div class="col"> <input id="direccion_form" type="text" class="form-control" placeholder="Strasse"> </div> </div> <div class="row mt-4"> <div class="col"> <input id="cp_form" type="input" class="form-control" placeholder="Postleitzahl"> </div> </div> <div class="row mt-4"> <div class="col"> <input id="ciudad_form" type="input" class="form-control" placeholder="Stadt"> </div> </div> <div id="addtoform" class="mt-4"></div> <div class="row mt-4"> <div class="col text-center"> <button data-lan="al" id="enviar_form" type="submit" class="btn btn-primary">BESTELLEN</button></div> </div> </form> </div> </div> </div> </div> </div> </div> </div>');
    (function () {
      editor.push(
        new FroalaEditor("#edit" + contador, {
          toolbarButtons: [
