            ...
            <button type="button" class="btn btn-info my-md-3" data-bs-toggle="modal" data-bs-target="#privacidadModal">
              ...
              <button type="button" class="btn btn-info my-md-3" data-bs-toggle="modal" data-bs-target="#garantiaModal">
                ...
                <div class="text-left my-md-3">
                 ...
                 <h5 class="text-left my-md-3 text-center">Contacto Alemán</h5>
                <div class="text-left my-md-3">
                  <img
                    src="img/contacto.png"
                    id="cn10"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" id="editMb1">
              ...
              <ul>
                ...
                <li>
                  <strong>Pour Safari™&nbsp;</strong>: choisissez «&nbsp;Safari&nbsp;», «&nbsp;Préférences&nbsp;» puis cliquez sur Sécurité&nbsp;»&nbsp;: Dans la section «&nbsp;Accepter les cookies&nbsp;» choisissez les options souhaitées ou suivez&nbsp;<a href="https://support.apple.com/fr-fr/HT1677" aria-describedby="a11y-external-message">ce lien</a>&nbsp;:
                </li>
                <li>
